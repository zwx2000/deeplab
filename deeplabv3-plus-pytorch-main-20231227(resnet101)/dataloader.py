...
class DeeplabDataset(Dataset):
    def __init__(self, annotation_lines, input_shape, num_classes, train, dataset_path):
        ...
        self.annotation_lines   = annotation_lines  # 存储图像文件路径及标签的列表
        self.length             = len(annotation_lines)    # 数据集的长度
        self.input_shape        = input_shape  # 输入图像的形状
