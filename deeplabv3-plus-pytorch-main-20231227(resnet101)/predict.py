#这段代码是一个Python脚本的入口点，它定义了不同的模式，可以根据这些模式执行不同的功能，
# 例如预测、视频检测、FPS测试、批量预测等。代码首先导入了必要的库和模块，
# 然后定义了一个DeeplabV3类的实例，用于加载和操作DeepLabv3+模型。
#----------------------------------------------------#
...
if __name__ == "__main__":
    ...
    #-------------------------------------------------------------------------#
    count           = False
    name_classes    = ["background","theme","text","image"]
