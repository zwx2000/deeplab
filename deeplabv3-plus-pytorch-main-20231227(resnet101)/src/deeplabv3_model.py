...
def deeplabv3_resnet50(aux, num_classes=4, pretrain_backbone=False):
...
def deeplabv3_resnet101(aux, num_classes=4, pretrain_backbone=False):
...
def deeplabv3_mobilenetv3_large(aux, num_classes=4, pretrain_backbone=False):
